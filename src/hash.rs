...
///
/// Convenience wrapper around [`hash_bytes`]`(`[`HashAlgorithm::Sha256`]`, data)`.
...
///
/// Accepts strings like `"sha256-LPJNul+wow4m6DsqxbninhsWHlwfp0JecwQzYpOLmCQ="`.
/// Returns `None` if the format or algorithm is invalid.
...
mod tests {
    ...
    fn sri_matches_nix_cli() {
        ...
        let bytes = hex::decode("2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824")
            .unwrap();
